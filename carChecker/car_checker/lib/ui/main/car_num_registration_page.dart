...
class CarNumRegistrationPage extends StatefulWidget {
  final Map<String, dynamic> dataList;
  const CarNumRegistrationPage({super.key, required this.dataList});

  @override
  State<CarNumRegistrationPage> createState() => _CarNumRegistrationPageState();
}

class _CarNumRegistrationPageState extends State<CarNumRegistrationPage> {
...
Future<void> showRegistrationDialog(BuildContext context, Map<String, dynamic> dataList) async {
  String _front_url;
  _front_url = UrlConfig.serverUrl.toString();
  final storage = FlutterSecureStorage();
  String? userCode = await storage.read(key: 'userId');
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        title: Center(child: Text('수정 완료시 필터에 대한\n데이터는 삭제됩니다.',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w700),)),
        actions: [
          Row(
